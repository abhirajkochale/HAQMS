...
export default function Dashboard() {
 ...
 setGlobalError('Worklist Sync Error: ' + e.message);
 console.error(e);
 } finally {
 setWorklistLoading(false);
 }
 ...
 setGlobalError(`API Error: ${data.sqlMessage || data.error}`);
 }
 } catch (e) {
 setGlobalError('Search Error: ' + e.message);
 console.error(e);
 } finally {
 ...
 <main className="flex-1 max-w-7xl w-full mx-auto p-6 sm:p-6">
 ...
 className={`py-3.5 px-1 border-b-2 font-bold text-sm transition-all whitespace-nowrap ${activeTab === 'reports' ? 'border-blue-500 text-blue-600 ' : 'border-transparent text-slate-400'}`}
 >
 System Audit Reports
 </button>
 <button
 onClick={() => setActiveTab('physicians')}
 className={`py-3.5 px-1 border-b-2 font-bold text-sm transition-all whitespace-nowrap ${activeTab === 'physicians' ? 'border-blue-500 text-blue-600 ' : 'border-transparent text-slate-400'}`}
 >
 Physician Registry
 </button>
 </>
 ...
 className={`py-3.5 px-1 border-b-2 font-bold text-sm transition-all whitespace-nowrap ${activeTab === 'patients' ? 'border-blue-500 text-blue-600 ' : 'border-transparent text-slate-400'}`}
 >
 Patient Registry Directory
 </button>
 <button
 onClick={() => setActiveTab('book')}
 className={`py-3.5 px-1 border-b-2 font-bold text-sm transition-all whitespace-nowrap ${activeTab === 'book' ? 'border-blue-500 text-blue-600 ' : 'border-transparent text-slate-400'}`}
 >
 ...
 className={`py-3.5 px-1 border-b-2 font-bold text-sm transition-all whitespace-nowrap ${activeTab === 'appointments' ? 'border-blue-500 text-blue-600 ' : 'border-transparent text-slate-400'}`}
 >
 My Scheduled Bookings
 </button>
 <button
 onClick={() => setActiveTab('queue')}
 className={`py-3.5 px-1 border-b-2 font-bold text-sm transition-all whitespace-nowrap ${activeTab === 'queue' ? 'border-blue-500 text-blue-600 ' : 'border-transparent text-slate-400'}`}
 >
 ...
 {checkinMessage && (
 <div className="p-6 mb-6 rounded-xl bg-blue-500/10 border border-blue-500/20 text-blue-600 flex items-center justify-between text-sm">
 <span>{checkinMessage}</span>
 <button onClick={() => setCheckinMessage('')} className="font-bold underline text-xs">Dismiss</button>
 </div>
 )}
 {globalError && (
 <div className="p-6 mb-6 rounded-xl bg-rose-500/10 border border-rose-500/20 text-rose-500 flex items-center justify-between text-sm">
 <span>{globalError}</span>
 <button onClick={() => setGlobalError('')} className="font-bold underline text-xs">Dismiss</button>
 </div>
 )}
 ...
 <thead>
 <tr className="text-slate-400 uppercase tracking-widest text-xxs font-bold border-b border-slate-200 ">
 ...
 className="text-xxs px-2.5 py-1 rounded bg-blue-500/10 text-blue-600 font-bold hover:bg-blue-500 hover:text-white transition-colors"
 >
 Check In
 </button>
 ...
 className="px-3 py-1 rounded border border-slate-200 hover:bg-blue-500/10 disabled:opacity-50 text-xs font-semibold"
 >
 Prev
 </button>
 <button
 ...
 {regMessage && (
 <div className={`p-3 text-sm rounded-lg mb-4 ${regMessage.startsWith('Success') ? 'bg-blue-500/15 text-blue-600 border border-blue-500/20' : 'bg-rose-500/15 text-rose-500 border border-rose-500/20'}`}>
 {regMessage}
 </div>
 )}

 <form onSubmit={handleRegisterPatient} className="flex flex-col gap-4 text-xs font-semibold text-slate-700">
 <div>
 ...
 <button
 type="submit"
 className="glow-btn w-full py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-extrabold text-sm rounded-lg shadow-md transition-colors duration-300 mt-2"
 >
 ...
 {bookingMessage && (
 <div className={`p-3 text-sm rounded-lg mb-4 ${bookingMessage.startsWith('Success') ? 'bg-blue-500/15 text-blue-600 border border-blue-500/20' : 'bg-rose-500/15 text-rose-500 border border-rose-500/20'}`}>
 {bookingMessage}
 </div>
 )}

 <form onSubmit={handleBookAppointment} className="flex flex-col gap-4 text-xs font-semibold text-slate-700">
 <div>
 ...
 <div className="flex flex-col gap-4">
 <div className="p-6 rounded-xl border border-blue-500/25 bg-blue-500/10 text-slate-700 text-xs leading-5">
 ...
 <p className="mt-4 text-sm font-semibold text-slate-400">Loading appointments...</p>
 </div>
 ...
 className="text-xxs px-2.5 py-1 rounded bg-blue-500/10 text-blue-600 font-extrabold hover:bg-blue-500 hover:text-white transition-colors"
 >
 Check In Patient
 </button>
 <button
 onClick={() => handleCompleteAppointment(app.id)}
 className="text-xxs px-2.5 py-1 rounded bg-slate-100 text-slate-700 font-extrabold hover:bg-blue-500 hover:text-white transition-colors"
 >
 Complete
 </button>
 </>
 ...
 <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-md flex flex-col gap-4">
 ...
 <p className="mt-4 text-sm font-semibold text-slate-400">Loading queue...</p>
 </div>
 ...
 <div
 key={t.id}
 className={`p-6 rounded-2xl border shadow-md relative overflow-hidden flex flex-col justify-between ${t.status === 'CALLING' ? 'border-blue-500 bg-blue-500/10' : 'border-slate-200 bg-slate-500/5'}`}
 >
 <div className="flex justify-between items-start">
 ...
 className="glow-btn px-4 py-2 bg-blue-600 text-white font-extrabold text-xs rounded-lg shadow hover:bg-blue-700 disabled:opacity-50 transition-colors"
 >
 ...
 <div className="p-6 text-center bg-slate-100 rounded-xl text-slate-400 text-xs font-semibold border border-dashed border-slate-200 ">
 ...
 <div className="p-6 bg-slate-500/5 border border-slate-200 rounded-xl">
 ...
 <td className="py-3.5 font-bold text-slate-800 ">
 {item.name}
 <span className="block text-xxs text-blue-600 font-semibold uppercase mt-0.5">{item.specialization}</span>
 </td>
 ...
 <td className="py-3.5 text-right font-bold text-blue-600 ">${item.revenue}</td>
 </tr>
 ))}
 </tbody>
 </table>
 ...
 <div
 key={doc.id}
 className="p-6 rounded-2xl border border-slate-200 bg-slate-500/5 flex flex-col justify-between"
 >
 <div>
 <span className="inline-flex px-2 py-0.5 rounded text-xxs font-extrabold tracking-wide uppercase bg-blue-500/10 text-blue-600 mb-2">
 {doc.department}
 </span>
 ...
 <span className="font-bold text-blue-600 ">Fee: ${doc.consultationFee}</span>
 </div>
 </div>
 ))}
 </div>
