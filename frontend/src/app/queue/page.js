...
export default function QueueMonitor() {
 ...
 <div className="bg-white p-6 sm:p-6 rounded-2xl shadow-md border border-slate-200 mb-8 flex flex-col md:flex-row flex-col justify-between items-start md:items-center gap-4">
 ...
 <div className="flex items-center gap-3">
 <span className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-blue-500/15 text-blue-600 text-xs font-bold uppercase tracking-wide border border-blue-500/20">
 ...
 {/* Error State */}
 {error && (
 <div className="p-6 mb-6 rounded-xl bg-rose-500/10 border border-rose-500/20 text-rose-500 flex items-center gap-3 text-sm">
 ...
 <div
 key={docId}
 className="bg-white rounded-2xl shadow-md border border-slate-200 overflow-hidden flex flex-col h-full hover:shadow-blue-500/5 hover:border-blue-500/30 transition-all duration-300"
 >
 {/* Doctor Title Header */}
 <div className="bg-slate-500/5 p-6 border-b border-slate-200 ">
 ...
 {docInfo.calling ? (
 <div className="bg-blue-500/10 border border-blue-500/30 p-6 rounded-2xl text-center shadow-sm relative overflow-hidden group">
 ...
 <span className="block text-5xl font-black text-blue-600 tracking-wider animate-pulse">
 ...
 <div className="bg-slate-100 border border-slate-200 p-6 rounded-2xl text-center shadow-sm">
 <span className="block text-2xl font-extrabold text-slate-400 tracking-wider italic">
 Idle
 </span>
