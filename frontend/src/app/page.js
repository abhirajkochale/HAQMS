...
export default function Home() {
 ...
 <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-500/10 text-blue-600 text-sm font-medium mb-6 animate-pulse">
 <Activity className="h-4 w-4" />
 Live Queue Tracking Enabled
 </div>
 
 <h1 className="text-4xl sm:text-6xl font-extrabold tracking-tight bg-gradient-to-r from-blue-600 to-blue-500 bg-clip-text text-transparent">
 HAQMS
 </h1>
 ...
 <div className="bg-white p-6 rounded-2xl shadow-md border border-slate-200 text-left hover:border-blue-500/50 hover:shadow-blue-500/10 transition-all duration-300 transform hover:-translate-y-1">
 <div className="p-3 bg-blue-500/10 text-blue-600 rounded-xl w-fit group-hover:bg-blue-500 group-hover:text-white transition-colors duration-300">
 ...
 <div className="mt-16 bg-white max-w-xl mx-auto p-6 rounded-2xl border border-rose-500/20 shadow-md flex gap-4 text-left">
