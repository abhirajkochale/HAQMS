...
export default function Login() {
 ...
 <Link href="/" className="inline-flex items-center gap-2 text-blue-600 font-extrabold text-3xl">
 ...
 <div className="bg-white py-8 px-6 shadow-md rounded-2xl border border-slate-200 ">
 <form className="flex flex-col gap-4 flex flex-col gap-4" onSubmit={handleSubmit}>
 {/* Validation Display */}
 ...
 className="block w-full pl-10 pr-3 py-2 border border-slate-300 bg-white/50 rounded-lg text-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all text-sm"
 ...
 className="block w-full pl-10 pr-10 py-2 border border-slate-300 bg-white/50 rounded-lg text-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all text-sm"
 placeholder="••••••••"
 />
 <button
 type="button"
 ...
 type="submit"
 disabled={loading}
 className="glow-btn w-full flex justify-center py-2.5 px-4 border border-transparent rounded-lg shadow-md text-sm font-bold text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-300 disabled:opacity-50"
 >
 ...
 className="text-left p-2 rounded bg-slate-100 hover:bg-blue-500/10 hover:text-blue-600 transition-colors text-slate-600 "
 >
